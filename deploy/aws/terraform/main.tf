# =============================================================================
# RDF-StarBase AWS ECS Deployment
# =============================================================================
...
variable "app_name" {
  ...
  type        = string
  default     = "rdf-starbase"
}

variable "container_image" {
  description = "Docker image for the application"
  type        = string
  default     = "rxcthefirst/rdf-starbase:latest"
}
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        {
          name  = "RDFSTARBASE_SERVE_STATIC"
          value = "true"
        },
        {
          name  = "RDFSTARBASE_REPOSITORY_PATH"
      ...
      mountPoints = [
        {
          sourceVolume  = "rdf-starbase-data"
          containerPath = "/data/repositories"
          readOnly      = false
        }
      ]
